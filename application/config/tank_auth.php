...
|--------------------------------------------------------------------------
*/
$config['website_name'] = (ENVIRONMENT == 'development') ? 'www.qrackets.com' : 'www.quickrackets.com';
$config['webmaster_email'] = 'founder@quickrackets.com';
...
$config['use_recaptcha'] = (ENVIRONMENT == 'development') ? FALSE : FALSE;
